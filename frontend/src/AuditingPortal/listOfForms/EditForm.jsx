                        ...
                        <form encType='multipart/form-data' onSubmit={(event) => {
                            ...
                            <div>
                                ...
                                <select value={dataToSend?.MaintenanceFrequency} onChange={(e) => {
                                    ...
                                    <option disabled >Choose Frequecy</option>
                                    ...
                                    <div style={{
                                        ...
                                        <div className='d-flex bg-white justify-content-between '>
                                            ...
                                            <div style={{
                                                ...
                                                <Select defaultValue={dataToSend?.questions[index]?.questionType} menuPosition="fixed" onChange={(selectedOption) => {
                                                    const updatedQuestions = [...questions]
                                        ...
                                        <div className='my-2 mt-4 d-flex justify-content-end'>
                                            ...
                                            <label className={style.switch}>
                                                <input autoComplete='off' className='ms-3' name='IsPass' checked={dataToSend?.questions[index]?.Required} type="checkbox" onChange={(event) => {
                                                    const updatedQuestions = [...questions];
