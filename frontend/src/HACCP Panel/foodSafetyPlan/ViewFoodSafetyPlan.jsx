                                ...
                                <div className={style.sec2}>
                                    <div className={style.inputParent}>
                                        ...
                                        <div style={{
                                            ...
                                            <select value={dataToSend?.Department.DepartmentName}  name='Department' style={{ width: "100%" }} required>
                                        ...
                                        <div className={style.inputParent}>
                                            ...
                                            <div style={{
                                                ...
                                                <select value={dataToSend?.DecisionTree.ConductHaccp.Process.ProcessName} name='Process' style={{ width: "100%" }} required>
                                                    <option value="" selected disabled>{dataToSend?.DecisionTree.ConductHaccp.Process.ProcessName}</option>
