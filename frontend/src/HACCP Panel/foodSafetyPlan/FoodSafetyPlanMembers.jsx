...
function FoodSafetyPlanMembers() {
    ...
    useEffect(() => {
        setMembers(safetyPlan?.DecisionTree.ConductHaccp.Members?.slice(startIndex, endIndex))
    }, [startIndex, endIndex])
    ...
    const search = (event) => {
        if (event.target.value !== "") {
            ...
            const searchedList = safetyPlan?.DecisionTree.ConductHaccp.Members.filter((obj) =>
    ...
    return (
        <>
                ...
                <div className={style.Btns}>
                    ...
                    {safetyPlan?.DecisionTree.ConductHaccp.Members.length > endIndex && (
...
export default FoodSafetyPlanMembers
