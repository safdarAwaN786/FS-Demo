                                                ...
                                                <div className='row'>
                                                    ...
                                                    <div className='col-lg-6 col-md-12 p-2'>
                                                        <select onChange={(e) => {
                                                            ...
                                                            <option value="" selected disabled>Occurance (1 to 5)</option>
                                                        ...
                                                        <select onChange={(e) => {
                                                            ...
                                                            <option value="" selected disabled>Severity (1 to 5)</option>
...
export default AddHACCPRiskAssessment
