        ...
        <>
            ...
            <div style={{
                ...
                <div className='col-lg-6 col-md-6 bg-light col-12 p-lg-5 p-md-4 d-flex justify-content-center align-items-center p-2'>
                    <h1 style={{
                        fontFamily: 'Poppins'
                    }} className='fw-bold text-center my-4'>Quality and Maintenance System</h1>
                </div>
                <div className='col-lg-6 col-md-6 bg-light col-12 p-lg-5 p-md-4 d-flex justify-content-center align-items-center p-lg-5 p-3'>
                    <div style={{
                        boxShadow: '2px 5px 20px rgb(197, 197, 197)',
                        borderRadius: '8px'
                    }} className='bg-white mx-lg-5 mx-2 px-lg-5 px-4 py-5 mx-auto'>
                        <h3>Welcome to New Seat 👋</h3>
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div className='my-3 mt-5'>
                                ...
                                }} type='text' name='userName' className='w-100 p-1 ' required />
                            </div>
                            <div className='my-3'>
                                ...
                                <div style={{
                                    ...
                                    <input style={{
                                        ...
                                        setCredentials({ ...credentials, [e.target.name]: e.target.value });
                                    }} type={showPassword ? 'text' : 'password'} name='password' className='w-100 border-0 p-1' required />
                                    {showPassword ? (
                                        <AiFillEyeInvisible onClick={togglePasswordVisibility} style={{
                                            cursor: 'pointer'
                                        }} className='fs-4 me-1' />
                                    ) : (

                                        <AiFillEye onClick={togglePasswordVisibility} style={{
                                            cursor: 'pointer'
                                        }} className='fs-4 me-1' />
                                    )}
                                </div>
                            </div>
                            <button type='sumit' className='btn btn-danger py-2 w-100 mt-5 '>Sign in</button>
                        </form>
                    </div>
                </div>
            </div>
